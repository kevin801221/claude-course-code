...
<2–3 句說明這個範例在 Claude Code 教學脈絡裡的位置>
...
### Step 4：寫 CLAUDE.md（給 Claude 看的規則）
...
> **新範例 = 6 個檔（README、CLAUDE、.gitignore、.env.example、pyproject.toml、src/）。少於 6 個問為什麼，多於 6 個也問為什麼。**
