...
allowed-tools: Read, Write, Bash(git log:*), Bash(git diff:*), Bash(date:*), Bash(mkdir:*)
---

# Daily Haiku（今日俳句）

把今天的工作壓縮成一首中文俳句，寫進日記檔。這是 Claude Code 教學 repo 裡用來示範「Slash Command + Bash + 檔案輸出」的有趣案例。
